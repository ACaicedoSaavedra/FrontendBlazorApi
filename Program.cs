...
builder.Services.AddHttpClient("ApiMetas_Proyectos", cliente =>
{
    // Usa la misma URL base de tu API de Backend donde se ejecutan tus controladores
    cliente.BaseAddress = new Uri("http://localhost:5031/");
});

builder.Services.AddHttpClient("ApiResonsables", cliente =>
{
    // Usa la misma URL base de tu API de Backend donde se ejecutan tus controladores
    cliente.BaseAddress = new Uri("http://localhost:5031/");
});
...
builder.Services.AddHttpClient("ApiProyectos_Productos", cliente =>
{
    // Usa la misma URL base de tu API de Backend donde se ejecutan tus controladores
    cliente.BaseAddress = new Uri("http://localhost:5031/");
});
